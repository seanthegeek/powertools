...
*Note*: This script will not configure or import any pinning policies to avvoid breaking SSL decryption for enterprises who do that. However, any certificate pinnings that you do configure (e.g. an internal CA) 
...
This is the default deployment configuration, and it satisfies [CIS Microsoft Windows 10 Enterprise (Release 1511) Benchmark, v1.1.0 ](https://benchmarks.cisecurity.org/tools2/windows/CIS_Microsoft_Windows_10_Enterprise_Release_1511_Benchmark_v1.1.0.pdf), Recommendation 18.9.22.
